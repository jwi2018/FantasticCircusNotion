...
namespace CompleteProject
{
    ...
    public class Purchaser : Singleton<Purchaser>, IStoreListener
    {
        ...
        public static string AppleproductId0 = "com.icecube.fantasticcircus.appstore.free.puzzle.255000coin";
        public static string AppleproductId1 = "com.icecube.fantasticcircus.appstore.free.puzzle.142000coin";
        public static string AppleproductId2 = "com.icecube.fantasticcircus.appstore.free.puzzle.61000coin";
        public static string AppleproductId3 = "com.icecube.fantasticcircus.appstore.free.puzzle.27500coin";
        public static string AppleproductId4 = "com.icecube.fantasticcircus.appstore.free.puzzle.11100coin";
        public static string AppleproductId5 = "com.icecube.fantasticcircus.appstore.free.puzzle.2000coin";
        public static string AppleproductId6 = "com.icecube.fantasticcircus.appstore.free.puzzle.noads";
        public static string AppleproductId7 = "com.icecube.fantasticcircus.appstore.free.puzzle.coinbank";
        public static string AppleproductPackageId1 = "com.icecube.fantasticcircus.appstore.free.puzzle.package1";
        public static string AppleproductPackageId2 = "com.icecube.fantasticcircus.appstore.free.puzzle.package2";
        public static string AppleproductPackageId3 = "com.icecube.fantasticcircus.appstore.free.puzzle.package3";
        public static string AppleproductPackageId4 = "com.icecube.fantasticcircus.appstore.free.puzzle.package4";
        public static string AppleproductPackageId5 = "com.icecube.fantasticcircus.appstore.free.puzzle.package5";
        
        public static string AppleProductLimitedPackage = "com.icecube.fantasticcircus.appstore.free.puzzle.package8";

        // Google Play Store-specific product identifier subscription product.
        private static readonly string kProductNameGooglePlaySubscription = "com.unity3d.subscription.original";

        public static string GoogleproductId0 = "com.icecube.fantasticcircus.android.free.puzzle.255000coin";
        public static string GoogleproductId1 = "com.icecube.fantasticcircus.android.free.puzzle.142000coin";
        public static string GoogleproductId2 = "com.icecube.fantasticcircus.android.free.puzzle.61000coin";
        public static string GoogleproductId3 = "com.icecube.fantasticcircus.android.free.puzzle.27500coin";
        public static string GoogleproductId4 = "com.icecube.fantasticcircus.android.free.puzzle.11100coin";
        public static string GoogleproductId5 = "com.icecube.fantasticcircus.android.free.puzzle.2000coin";
        public static string GoogleproductId6 = "com.icecube.fantasticcircus.android.free.puzzle.noads";
        public static string GoogleproductId7 = "com.icecube.fantasticcircus.android.free.puzzle.coinbank";
        public static string GoogleproductPackageId1 = "com.icecube.fantasticcircus.android.free.puzzle.package1";
        public static string GoogleproductPackageId2 = "com.icecube.fantasticcircus.android.free.puzzle.package2";
        public static string GoogleproductPackageId3 = "com.icecube.fantasticcircus.android.free.puzzle.package3";
        public static string GoogleproductPackageId4 = "com.icecube.fantasticcircus.android.free.puzzle.package4";
        public static string GoogleproductPackageId5 = "com.icecube.fantasticcircus.android.free.puzzle.package5";
        public static string GoogleproductPackageId6 = "com.icecube.fantasticcircus.android.free.puzzle.package6";
        public static string GoogleproductPackageId7 = "com.icecube.fantasticcircus.android.free.puzzle.package7";

        public static string GoogleproductLimitedPackage = "com.icecube.fantasticcircus.android.free.puzzle.package8";
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
        {
            ...
            else if (string.Equals(args.purchasedProduct.definition.id, SubscriptionProductList[ESubsType.AOSWeekVip],
                StringComparison.Ordinal))
            {
                Debug.Log(string.Format("ProcessPurchase : PASS. Product: '{0}'", args.purchasedProduct.definition.id));

                //StartCoroutine(PlayerData.GetInstance.SubsCheckCoroutine());

                if (actPurchase != null)
                {
                    Debug.Log("[vip] 상점 새로고침");
                    actPurchase?.Invoke();
                    actPurchase = null;
                }
            }
            else if (string.Equals(args.purchasedProduct.definition.id, SubscriptionProductList[ESubsType.AOSMonthVip],
                StringComparison.Ordinal))
            {
                Debug.Log(string.Format("ProcessPurchase : PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            ...
            */
            ...
            // else if (string.Equals(args.purchasedProduct.definition.id, SubscriptionProductList[ESubsType.IOSWeekVip],
            //     StringComparison.Ordinal))
            // {
            //     Debug.Log(string.Format("ProcessPurchase : PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            //     SubscriptionManager a =
            //         new SubscriptionManager(
            //             m_StoreController.products.WithID(SubscriptionProductList[ESubsType.IOSWeekVip]), null);
            //
            //     var standardDay = a.getSubscriptionInfo().getPurchaseDate();
            //     Debug.Log(string.Format("[vip]구독 날짜 : {0}", standardDay));
            //
            //     PlayerData.GetInstance.SetVipInfo(ESubsType.IOSWeekVip);
            //
            //     for (int i = 0; i < 7; i++)
            //     {
            //         Debug.Log(string.Format("[vip] {0}을 추가합니다.", standardDay + TimeSpan.FromDays(i)));
            //         PlayerData.GetInstance.AddVipDay(standardDay + TimeSpan.FromDays(i));
            //     }
            //
            //     if (actPurchase != null)
            //     {
            ...
            //     }
            // }
            // else if (string.Equals(args.purchasedProduct.definition.id, SubscriptionProductList[ESubsType.IOSMonthVip],
            //     StringComparison.Ordinal))
            // {
            //     Debug.Log(string.Format("ProcessPurchase : PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            //     SubscriptionManager a =
            //         new SubscriptionManager(
            //             m_StoreController.products.WithID(SubscriptionProductList[ESubsType.IOSMonthVip]), null);
            //
            //     var standardDay = a.getSubscriptionInfo().getPurchaseDate();
            //     Debug.Log(string.Format("[vip]구독 날짜 : {0}", standardDay));
            //
            //     PlayerData.GetInstance.SetVipInfo(ESubsType.IOSMonthVip);
            //
            //     for (int i = 0; i < 7; i++)
            //     {
            //         Debug.Log(string.Format("[vip] {0}을 추가합니다.", standardDay + TimeSpan.FromDays(i)));
            ...
            if (Application.platform == RuntimePlatform.Android)
            {
                switch (num)
                {
                    ...
                    case 7:
                        ...
                        break;
                    // case 8:
                    //     p = m_StoreController.products.WithID(SubscriptionProductList[ESubsType.AOSWeekVip]);
                    //     break;
                    // case 9:
                    //     p = m_StoreController.products.WithID(SubscriptionProductList[ESubsType.AOSMonthVip]);
                    //     break;
                    default:
                        p = m_StoreController.products.WithID(GoogleproductPackageId3);
                        break;
            ...
            else
            {
                switch (num)
                {
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        p = m_StoreController.products.WithID(SubscriptionProductList[ESubsType.IOSWeekVip]);
                        break;
                    case 9:
                        p = m_StoreController.products.WithID(SubscriptionProductList[ESubsType.IOSMonthVip]);
                        break;
                    default:
                        p = m_StoreController.products.WithID(AppleproductPackageId3);
                        break;
        ...
        public void Init()
        {
           ...
           if (!SubscriptionProductList.ContainsKey(ESubsType.AOSWeekVip))
            {
                SubscriptionProductList.Add(ESubsType.AOSWeekVip, "com.icecube.fantasticcircus.aos.vip01");
            }

            if (!SubscriptionProductList.ContainsKey(ESubsType.AOSMonthVip))
            {
                SubscriptionProductList.Add(ESubsType.AOSMonthVip, "com.icecube.fantasticcircus.aos.vip02");
            }

            /*if (!SubscriptionProductList.ContainsKey(ESubsType.IOSWeekVip))
           {
               SubscriptionProductList.Add(ESubsType.IOSWeekVip, "");
           }

           if (!SubscriptionProductList.ContainsKey(ESubsType.IOSMonthVip))
           {
               SubscriptionProductList.Add(ESubsType.IOSMonthVip, "");
           }*/
        ...
        public void InitializePurchasing()
        {
            ...
            builder.AddProduct(SubscriptionProductList[ESubsType.AOSWeekVip], ProductType.Subscription);
            builder.AddProduct(SubscriptionProductList[ESubsType.AOSMonthVip], ProductType.Subscription);
            ...
            //builder.AddProduct(SubscriptionProductList[ESubsType.IOSWeekVip], ProductType.Subscription);
            //builder.AddProduct(SubscriptionProductList[ESubsType.IOSMonthVip], ProductType.Subscription);
        ...
        public bool PurchaserLoadCheck()
        {
            ...
            if (m_StoreController.products.WithID(SubscriptionProductList[ESubsType.AOSWeekVip]) == null) return false;
            if (m_StoreController.products.WithID(SubscriptionProductList[ESubsType.AOSMonthVip]) == null) return false;
            ...
            if (m_StoreController.products.WithID(SubscriptionProductList[ESubsType.IOSWeekVip]) == null) return false;
            if (m_StoreController.products.WithID(SubscriptionProductList[ESubsType.IOSMonthVip]) == null) return false;
